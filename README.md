...
График №5. Демонстрирует полное распределение рейтингов для каждой ценовой категории (Low, Medium, High).
![Демонстрирует полное распределение (плотность) рейтингов для каждой ценовой категории (Low, Medium, High).](images/grafik-5.png.png)
